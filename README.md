...
**Ruby Catalog** is an app to manage the data of libraries,music ablums, games. ect...
...
```bash
  git clone https://github.com/YoutLone/Ruby-Catalog.git
```
...
Feel free to check the [issues page](https://github.com/YoutLone/Ruby-Catalog/issues).
...
I would like to thank microverse  and contributors for this project 
